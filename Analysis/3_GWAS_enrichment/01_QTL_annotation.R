...
rqtl <- fread(paste0('/workspace/rsrch1/ychen/Projects/Project03_human_circadian/rQTL/cis_QTL/00_rQTL_mapping/04_Results_p/cis_rhyQTL_tissue/', tissue, '.rQTL'))
annot_rqtl <- rqtl$rsid
...
annot_eqtl <- filter(rsid, variant_id %in% eqtl$variant_id)$rs_id_dbSNP151_GRCh38p7
