...
for(x in unique(color$Class)[unique(color$Class) !=  "Cells"]){
  ...
  pdf(paste0('./Figures/00_rQTL_mapping/phase_distribution/font_annotation_color/', gsub('/', '', x),'_annot_font.pdf'), width = 5, height = 2, useDingbats = F)
  print(
...
################################## Liver ###################################################
pdf(paste0('./Figure/00_rhyGene_phase/Liver.pdf'), width = 2, height = 2, useDingbats = F)
print(
